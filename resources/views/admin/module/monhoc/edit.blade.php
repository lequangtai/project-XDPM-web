      ...
      <div class="col-xs-6">
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" name="tenmonhoc" class="form-control" value="{!!old('tenmonhoc', $data['tenmonhoc'])!!}" />
            </div>
          </div>
          <div class="form-group">
            <label for="inputPassword3" class="col-sm-3 control-label">Số tiết</label>
            <div class="col-sm-9">
              <input type="text" name="sotiet" value="{!!old('sotiet', $data['sotiet'])!!}" class="form-control" >
            </div>
          </div>
            <div class="form-group ">
              <label class="col-sm-3" >Hệ số</label>
              <select class="col-sm-8 select2" name="sltHeso">
              <option>{{$data["heso"]}}</option>
