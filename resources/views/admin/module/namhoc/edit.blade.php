      ...
      <div class="box box-info">
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" name="tennamhoc" class="form-control" value="{!!old('tennamhoc',$data["tennamhoc"]) !!}" />
            </div>
          </div>
        </div>
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" name="khoahoc" class="form-control" value="{!!old('khoahoc',$data["khoahoc"]) !!}"/>
            </div>
          </div>
        </div>
