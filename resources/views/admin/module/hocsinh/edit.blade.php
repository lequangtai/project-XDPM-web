@extends('admin.app')
@section('title','Cập nhật thông tin học sinh')
@section('content')
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" value="{!!old('tenhocsinh',$hocsinh["hoten"])!!}" name="tenhocsinh" placeholder="Nhập tên">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Ngày sinh</label>
              <div class="col-sm-9">
                <input type="date" class="form-control" value="{!!old('ngaysinh',$hocsinh["ngaysinh"])!!}" name="ngaysinh" placeholder="Nhập địa chỉ">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Địa chỉ</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" value="{!!old('diachi',$hocsinh["diachi"])!!}" name="diachi" placeholder="Nhập địa chỉ">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Tôn giáo</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" value="{!!old('tongiao',$hocsinh["tongiao"])!!}" name="tongiao" placeholder="Nhập địa chỉ">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Dân tộc</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" value="{!!old('dantoc',$hocsinh["dantoc"])!!}" name="dantoc" placeholder="Nhập địa chỉ">
              </div>
            </div>
            <div class="form-group">
