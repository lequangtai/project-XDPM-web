      ...
      <div class="col-xs-7">
        <div class="box box-danger">
            ...
            <a href="{{ route('danh-sach-lop-hoc') }}" class="btn btn-danger margin btn-labeled" style="position: relative;padding-left: 50px"><b><i class="fa fa-close"></i></b>Close</a>
             <a href="{{ route('them-nam-hoc') }}" class="btn btn-info margin btn-labeled" style="position: relative;padding-left: 50px"><b><i class="fa fa-close"></i></b>Thêm năm học</a>
              <a href="{{ route('them-khoi-lop') }}" class="btn btn-default margin btn-labeled" style="position: relative;padding-left: 50px"><b><i class="fa fa-close"></i></b>Thêm khối lớp</a>
               <a href="{{ route('them-nguoi-dung') }}" class="btn btn-warning margin btn-labeled" style="position: relative;padding-left: 50px"><b><i class="fa fa-close"></i></b>Thêm giáo viên</a>
        </div>
