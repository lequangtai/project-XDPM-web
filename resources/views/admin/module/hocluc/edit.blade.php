      ...
      <div class="box box-info">
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" name="tenhocluc" class="form-control" value="{!!old('tenhocluc',$data["tenhocluc"])!!}" />
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-4 control-label">Điểm cận</label>
            <div class="col-sm-8">
              <input type="text" name="diemcan" class="form-control" value="{!!old('diemcan',$data["diemcan"])!!}" />
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-4 control-label">Điểm khống chế</label>
            <div class="col-sm-8">
              <input type="text" name="diemkhongche" class="form-control" value="{!!old('diemkhongche',$data["diemkhongche"])!!}" />
            </div>
          </div>
        </div>
