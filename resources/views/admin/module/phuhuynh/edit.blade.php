      ...
      <div class="col-xs-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Cập nhật Phụ Huynh</h3>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" value="{!!old('tenphuhuynh', isset($data["tenPH"]) ?$data["tenPH"] :null)!!}" name="tenphuhuynh" placeholder="Nhập tên phụ huynh">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Số điện thoại</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" value="{!!old('sodienthoai', isset($data["sdt"]) ?$data["sdt"] :null)!!}" name="sodienthoai" placeholder="Số điện thoại">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Địa chỉ</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" value="{!!old('diachi', isset($data["diachi"]) ?$data["diachi"] :null)!!}" name="diachi" placeholder="Nhập địa chỉ">
              </div>
            </div>
             ...
             <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="password" class="form-control" value="{!!old('txtPass', isset($data["mkdangnhap"]) ?$data["mkdangnhap"] :null)!!}" name="txtPass" placeholder="Mật khẩu">
              </div>
            </div>
             <div class="form-group">
